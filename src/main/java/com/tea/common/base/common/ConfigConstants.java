package com.tea.common.base.common;
...
public class ConfigConstants {
	 ...
	 * @category  提现T1开关
	 */
	public  static final String t1StatusSwitch= Constants.YunWei + "/feeconfig/t1StatusSwitch";
	
	/**
	 * @category  提现T0开关
	 */
	public  static final String t0StatusSwitch= Constants.YunWei + "/feeconfig/t0StatusSwitch";
	
	/**
	 * @category  提现收费比例(T0)
	 */
	public  static final String t0SinglePenProportion= Constants.YunWei + "/feeconfig/t0SinglePenProportion";
	
	/**
	 * @category  提现收费基数(T0)
	 */
	public  static final String t0SinglePenBase= Constants.YunWei + "/feeconfig/t0SinglePenBase";
