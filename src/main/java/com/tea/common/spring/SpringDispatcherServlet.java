...
import com.tea.common.base.jstl.FieldELResolver;
import com.tea.common.loader.CustomerSetting;
import com.tea.common.spring.dubbo.AnnotationBeanEx;
...
import com.tea.common.xnex.AnnotationConfigWebApplicationContextEx;
...
public class SpringDispatcherServlet extends HttpServlet {
    ...
    public static final String localWindowsConfigName = CustomerSetting.localWindowsConfigName;// "d:/config.properties";
    public static final String linuxConfigName = CustomerSetting.linuxConfigNameWeb;// "/data/config/config.properties";
