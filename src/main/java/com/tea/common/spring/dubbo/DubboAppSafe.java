...
import com.tea.common.loader.CustomerSetting;
import com.tea.common.spring.AppSpringDispatcherServlet;
...
import com.tea.common.common.IRedisKeeperLock;
import com.tea.common.common.RedisKeeperLock;
import com.tea.common.common.RedisServiceImp;
import com.tea.common.util.Device;
import com.tea.common.util.NetWorkUtil;
import com.tea.common.util.PropertiesUtil;
import com.tea.common.xnex.AnnotationConfigApplicationContextEx;
import com.tea.common.xnex.LocalNetServer;

public class DubboAppSafe {
	static 
	{
	...
	private static final String jarConfigName = "/config.properties";
	private static final String localWindowsConfigName = CustomerSetting.localWindowsConfigName;// "d:/config.properties";
	private static final String linuxConfigName = CustomerSetting.linuxConfigNameService;// "/data/config/config.properties";
...
//		System.setProperty("LocalStop.Exit", "Stop");
		...
		String groupName = p.getProperty("dubboGroup",null);
		if(StringUtils.isNotEmpty(groupName))
		{
			registryConfig.setGroup(groupName);
		}
