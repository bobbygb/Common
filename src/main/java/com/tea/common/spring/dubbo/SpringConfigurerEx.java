package com.tea.common.spring.dubbo;
...
import com.tea.common.common.ConfigValueImp;
import com.tea.common.common.IConfigValue;
import com.tea.common.common.IZooKeeperConfig;
import com.tea.common.common.ZooKeeperConfigImp;
import com.tea.common.common.zkclient.IZkClientService;
import com.tea.common.common.zkclient.ZkClientServiceImp;
import com.tea.common.spring.DBInit;
import com.tea.common.spring.dao.JdbcTemplateTimeFix;
import com.tea.common.spring.dubbo.kryo2.Kryo2Factory;
import com.tea.common.util.AtomicDataSource;
import com.tea.common.util.NetWorkUtil;
import com.tea.common.xnex.CloseEx;
import com.tea.common.xnex.Log4j2LogBack;
import com.tea.common.xnex.RequestMappingHandlerMappingEx;
...
public class SpringConfigurerEx extends ApplicationObjectSupport implements
	...
	static {
		...
		try {
			Class.forName("com.tea.common.config.CustomerConfig");
		} catch (ClassNotFoundException e) {

		}
		// 添加拦截器
		addInterceptorsEx(com.tea.common.util.HttpContextHandler.class);
	}
...
//			sds.setValidationQueryTimeout(5);
	...
	public JdbcTemplate jdbcTemplate(DataSource dataSource) {
		JdbcTemplate jdbcTemplate = new JdbcTemplateTimeFix();
